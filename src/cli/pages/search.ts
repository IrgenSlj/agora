...
// enabled upstream registry (official, glama, pulsemcp, skills-github, github plus opt-in
// smithery/huggingface) plus the bundled local catalog is queried, deduped, and merged. Per-source
