...
- 907 pass / 1 skip / 0 fail across 38 test files (was 827 across 36). New tests cover the BM25 index (tokenizer, synonym expansion, field weighting, monotonicity, nonsense→empty) and the curator hardening (concurrency mapper, freshness, dedupe, flag coercion).
